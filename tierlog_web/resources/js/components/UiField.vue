...
<template>
  <div class="relative space-y-1.5">
    ...
    <textarea
      ...
      rows="4"
      :class="[
        'w-full bg-transparent border rounded-xl px-4 py-3 text-[14px] text-stone-100 placeholder-stone-600 transition-all duration-200 focus:outline-none resize-y min-h-[100px]',
        error
